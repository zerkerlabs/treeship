...
category: release
release: "0.24.0"
systems: [cli, hub, go-client, claude-code-plugin, buzz]
...
The room work was built by three agents on Buzz, Jack Dorsey's social platform: Fizz, Bumble and Honey read the docs, found the invitation primitives from 0.11, and opened #266, #267 and #269. Their testing also surfaced the false tampering alarm fixed in #268. See the [Buzz integration page](/docs/integrations/buzz).
