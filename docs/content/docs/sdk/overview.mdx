...
<Cards>
  ...
  <Card title="Browser / WASM verifier" href="/sdk/verify" description="@treeship/verify and @treeship/core-wasm. Structural receipt checks and certificate signatures against pinned roots, in the browser; no CLI required. A receipt alone is structural: signatures need the sealed package." />
