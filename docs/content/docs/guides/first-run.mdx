...
Or `curl -fsSL https://www.treeship.dev/setup | sh`, which installs the CLI and runs the rest of this page for you. See [how Treeship is distributed](/docs/guides/install) for every channel and why each absence is on purpose.
