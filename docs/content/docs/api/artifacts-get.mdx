...
| `rekor_index` | integer or null | Sigstore Rekor global log index |
| `rekor` | object or absent | The anchoring outcome, in the same shape as the push response. Absent for artifacts pushed before outcomes were recorded |
