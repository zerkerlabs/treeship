...
| `rekor_index` | integer or null | No | Ignored. The hub used to store this caller-supplied value and serve it back as if it were an anchor (TS-2026-003). Checkpoints are not anchored yet |
...
| `rekor_index` | null | Always null until the hub anchors checkpoints itself |
