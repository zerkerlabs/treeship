...
description: Named links from your Treeship to Hub workspaces. Attach, detach, and kill independently.
---

import { Callout } from 'fumadocs-ui/components/callout';

A hub connection is a named link between your local Treeship and a workspace on Hub. You push receipts through it. Other people verify them there.

## The tmux model

Hub connections work like tmux sessions. You can attach, detach, and kill them independently. Your Treeship (the trust domain) stays the same regardless of how many hub connections exist.
...
The Treeship key stays the same across all hub connections. Artifacts never change. Hub connections only control where artifacts appear on Hub.
