...
| **Dock** | Authenticated connection to the treeship.dev Hub | `dock_id` + DPoP keypair / `treeship dock` |
| **Hub** | Hosted infrastructure where Treeships dock and share artifacts | treeship.dev API |
