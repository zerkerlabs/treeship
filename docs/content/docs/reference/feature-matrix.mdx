...
| Workflow declarations and conformance | `experimental` | `treeship attest receipt`, `treeship session start` | [/docs/specs/workflow-declarations.md](/docs/specs/workflow-declarations.md) |
