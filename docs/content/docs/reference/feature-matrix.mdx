...
| Anonymous usage telemetry (opt-out) | `stable` | `treeship telemetry status`, `treeship telemetry enable`, `treeship telemetry disable` | [Telemetry](/docs/about/telemetry) |
