...
| Judgement receipts (judgement.v1) | `beta` | `treeship attest receipt`, `treeship package verify` | [Predicate registry](/docs/reference/predicates), [package](/docs/cli/package) |
