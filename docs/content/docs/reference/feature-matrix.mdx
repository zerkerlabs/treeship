...
| Workflow declarations and conformance | `experimental` | `treeship attest receipt`, `treeship session start` | [workflow-declarations spec](https://github.com/zerkerlabs/treeship/blob/main/docs/specs/workflow-declarations.md) |
