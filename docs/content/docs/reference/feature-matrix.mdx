...
| Judge slot (treeship judge) | `beta` | `treeship judge` | [judge](/docs/cli/judge), [Claude Code](/docs/integrations/claude-code), [Predicate registry](/docs/reference/predicates) |
