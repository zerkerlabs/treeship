...
cargo install --git https://github.com/zerkerlabs/treeship treeship-cli --features otel
```
...
Rebuild with: cargo install --git https://github.com/zerkerlabs/treeship treeship-cli --features otel
```
