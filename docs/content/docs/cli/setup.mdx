...
`setup --format json` returns a structured payload an agent can branch on directly:
...
```json
{
  ...
  "ship_id": "...",
  "config_path": "...",
  "detected": [{ "surface": "...", "display_name": "...", "confidence": "...", "recommended_harness_id": "..." }],
  "cards": { "...": "..." },
  "instrumented": ["..."],
  "smoke": { "...": "..." },
  "next_steps": ["..."],
...
`error` is set (and the rest partial) if setup stops early, e.g. because the workspace isn't initialized. To inspect the same information through other commands:
