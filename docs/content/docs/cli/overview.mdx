...
treeship dock login                     # connect to Hub (or reconnect)
treeship dock login --name acme-corp    # named dock for separate workspace
...
treeship dock push <id> --dock <name>   # push to specific dock
treeship dock push <id> --all           # push to all docks
